...
declare global {
  ...
  interface AipriAccount {
    accountId: string; // Immutable unique key
  ...
  interface ElectronAPI {
    ...
    aipriRemoveAccount: (accountId: string) => Promise<AipriRemoveAccountResult>;
    aipriUpdateAccount: (
      accountId: string,
      credentials: AipriLoginCredentials,
    ) => Promise<AipriUpdateAccountResult>;
    aipriSwitchAccount: (accountId: string) => Promise<AipriSwitchAccountResult>;
    // Window controls
    windowMinimize: () => void;
    windowMaximize: () => void;
    windowClose: () => void;
